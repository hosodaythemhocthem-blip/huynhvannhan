...
const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex bg-slate-100">
      {/* ================= SIDEBAR ================= */}
      <aside className="hidden md:flex w-72 flex-col bg-white border-r border-slate-200 shadow-sm">
        {/* Logo */}
            ...
            <div className="flex-1 max-w-xl">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 rounded-full bg-slate-100 focus:bg-white border border-transparent focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100 outline-none text-sm transition"
                />
              </div>
            </div>
